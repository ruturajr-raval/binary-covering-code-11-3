...
hard children, an exhaustive 350-branch fourth-word split has 184
...
The next retained layer studies four hard children below the parent
...
\bottomrule
\end{tabular}
\caption{Certified branch-level results inside four selected hard
third-word children.}
\label{tab:fourth}
\end{table}
...
retained branches.  Within four selected hard children, 324 of 350
