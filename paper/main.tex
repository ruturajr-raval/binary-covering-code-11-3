...
\hypersetup{
  pdftitle={Certified Branch Reductions for the Binary Covering Number K2(11,3)},
  pdfauthor={Ruturaj R Raval},
  pdfsubject={Certified branch reductions for a binary covering-code problem},
  pdfkeywords={covering codes, coding theory, SAT, DRAT, computer-assisted proof}
}
...
The next retained layer studies four selected unresolved children below the
parent \texttt{w4-weight5-}\allowbreak\texttt{intersection0}.  Once three
nonzero words are fixed,
...
The paper-inclusive archival release is version \texttt{v0.3.1}, DOI
\href{https://doi.org/10.5281/zenodo.22647766}
{10.5281/zenodo.22647766}.  This archival and documentation patch adds
an explicit compiled PDF and deterministic source bundle; the theorem,
proof certificates, retained data, and computations are unchanged.
